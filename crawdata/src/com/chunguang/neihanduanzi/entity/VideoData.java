...
public class VideoData {
	...
	public List<VideoGroupData> getVideoGroups(){
		videogroup = new ArrayList<VideoGroupData>();
		JSONArray jarr = JSONArray.parseArray(datastr);
		for (JSONObject j : jarr.toArray(new JSONObject[jarr.size()])) {
			videogroup.add(new VideoGroupData(j.getString("group")));
		}
		return videogroup;
	}
